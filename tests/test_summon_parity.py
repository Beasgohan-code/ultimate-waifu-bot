...
SUMMON_COMMANDS: dict[str, str] = {
    ...
    "work": "earn coins",
    "steal": "rob a player",
    "rob": "take a tier of their purse (20-70% under 1,000 … flat 1,000-50,000 above 1M)",
    "bomb": "spend one Bomb: burns their shield charge, else hijacks a random unlocked copy",
    ...
    # gacha
    "pull": "gacha roll",
    "hclaim": "free claim from the claim ladder (premium: 2/day, high tiers boosted)",
    ...
    "buy": "buy from market",
    "skip": "1 resets /daily, 2 loads a bomb shield, 3 a steal shield",
    "inventory": "item bag",
    "inv": "alias",
    ...
    "bid": "place a bid (escrowed; or reply with a number after the custom-bid prompt)",
